...
my_w.title('Parkinson Detection Model')
my_font1=('times',20,'bold')
l1 = tk.Label(my_w,text='Input Image',width=30,font=my_font1)
l1.grid(row=1,column=1)
b1 = tk.Button(my_w,text='Upload Image',width=20,font=my_font1,command = lambda:upload_file())
...
def Prediction(img,_model):
  ...
  print('The Prediction Class is ' ,classes_dir[pred])
