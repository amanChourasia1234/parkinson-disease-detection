...
dir_sp_train = 'data/drawings/spiral/training'
dir_sp_test = 'data/drawings/spiral/testing'
dir_wv_train = 'data/drawings/wave/training'
dir_wv_test = 'data/drawings/wave/testing'
...
datagen = ImageDataGenerator(horizontal_flip=True,vertical_flip=True,rotation_range=20,zoom_range=0.2,width_shift_range=0.2,
                             height_shift_range=0.2,shear_range=0.1,fill_mode="nearest")
...
wv_4=model3.fit(datagen.flow(trainx_wv,trainy_wv,batch_size=32),validation_data=(testx_wv,testy_wv),epochs=70)
...
plt.plot(epochs3,value_acc3,'b',label='Loss of Validation data')
plt.title('Training vs validation accuracy - Spiral')
plt.legend(loc=0)
plt.figure()
plt.show()
...
plt.plot(epochs4,value_acc4,'b',label='Loss of Validation data')
plt.title('Training vs validation accuracy - Spiral')
plt.legend(loc=0)
plt.figure()
plt.show()
...
load_img("data/drawings/spiral/testing/healthy/V10HE01.png",target_size=(100,100))


image = load_img("data/drawings/spiral/testing/healthy/V10HE01.png",target_size=(100,100))
...
load_img("data/drawings/wave/testing/parkinson/V03PO01.png",target_size=(100,100))


image2 = load_img("data/drawings/wave/testing/parkinson/V03PO01.png",target_size=(100,100))
